            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong>{{ __('Create') }} {{ __('School') }}</strong></div>
                    {!! Form::open(array('route' => 'escuelas.store','method'=>'POST')) !!}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($carrera as $value)
                                <div class="form-check">
                                    {{ Form::checkbox('carrera[]', $value->id, false, array('class' => 'form-check-input')) }}
